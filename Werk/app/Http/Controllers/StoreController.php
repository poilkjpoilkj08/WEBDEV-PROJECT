...
class StoreController extends Controller
{
    ...
    public function update_product(Request $request, $product_id){
        ...
        if ($request->hasFile('image')) {
            ...
            if ($product->image_path) {
                $oldImagePath = public_path('product_image/' . $product->image_path);
    ...
    public function payment_status($order_id){
        ...
        if ($order->status == 'paid') {
            ...
            return redirect()->route('store')->with('error', 'Payment is pending. Please complete it.');
        } else {
            return redirect()->route('store')->with('error', 'Payment failed or expired.');
        }
    }
