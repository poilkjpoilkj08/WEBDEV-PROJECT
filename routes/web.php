...
->group(function () {
    ...
    Route::middleware(['role:admin,owner'])->group(function () {
        ...
        // ── Publishers CRUD ──────────────────────────────────────────────────
        Route::get('/admin/publishers', [PublisherController::class, 'index'])->name('admin.publishers.index');
        ...
        Route::get('/admin/publishers/{publisher}', [PublisherController::class, 'show'])->name('admin.publishers.show');
        Route::get('/admin/publishers/{publisher}/edit', [PublisherController::class, 'edit'])->name('admin.publishers.edit');
        Route::put('/admin/publishers/{publisher}', [PublisherController::class, 'update'])->name('admin.publishers.update');
        Route::delete('/admin/publishers/{publisher}', [PublisherController::class, 'destroy'])->name('admin.publishers.destroy');
        Route::get('/api/publishers', [PublisherController::class, 'getOrCreate'])->name('api.publishers.get-or-create');
...
// --- Recommendation Roulette ---
    Route::get('/roulette', function () {
        $books = \App\Models\Book::where('status', 'available')
                                ->orderBy('created_at', 'desc')
                                ->take(12)
                                ->get();
        return view('roulette.roulette', compact('books'));
    })->name('books.roulette');
